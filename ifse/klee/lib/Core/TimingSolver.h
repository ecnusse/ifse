...
public:
  ...
  // For arrays that have been set symcret, restrict their values to the concrete values
  ...
  // For arrays that have been set symcret, restrict their values to the concrete values
  llvm::Optional<std::pair<Assignment, ref<ConstantExpr>>> getValueAndSolution(const ConstraintSet &,
                                                                                ref<Expr> expr,
                                                                                SolverQueryMetaData &metaData);
