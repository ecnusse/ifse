...
- `ifse` contains all source code and executable artifacts of our tool, including:
  ...
  - `README.md`: Guide on how to use IFSE through command line.

  - `BUILD.md`: Guide on how to recompile IFSE after modifying its source code.
